...
const styles = {
  ...
  activeTab: { padding: '14px 27px', backgroundColor: 'white', color: '#3182ce', border: 'none', borderRadius: '12px 12px 0 0', fontWeight: 'bold', cursor: 'pointer', fontSize: '16px' },
  inactiveTab: { padding: '14px 27px', backgroundColor: '#cbd5e0', color: '#4a5568', border: 'none', borderRadius: '12px 12px 0 0', fontWeight: 'bold', cursor: 'pointer', fontSize: '16px' },
  headerControl: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '22px', paddingBottom:'16px', borderBottom:'1px solid #edf2f7' },
  reportContent: { backgroundColor: 'white', padding: '32px', borderRadius: '0 16px 16px 16px', boxShadow: '0 4px 10px rgba(0,0,0,0.05)' },
  pageTitle: { margin: 0, fontSize: '24px', fontWeight: 'bold', color: '#1a365d' },
  controlGroup: { display: 'flex', gap: '12px' },
  printBtn: { padding: '10px 18px', backgroundColor: '#3182ce', color: 'white', border: 'none', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer', fontSize: '15px' },
  datePicker: { padding: '10px', borderRadius: '8px', border: '1px solid #cbd5e0', fontSize: '15px' },
  topGrid: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '20px' },
  mainCard: { backgroundColor: '#f8fafc', padding: '22px', borderRadius: '14px', textAlign: 'center', border: '1px solid #edf2f7' },
  cardTitle: { margin: '0 0 11px 0', fontSize: '16px', color: '#4a5568', fontWeight: 'bold' },
  mainValue: { margin: 0, fontSize: '30px', fontWeight: '900', color: '#2d3748' },
  middleGrid: { display: 'flex', gap: '20px', marginBottom: '20px' },
  contentCard: { backgroundColor: '#f8fafc', padding: '17px', borderRadius: '14px', border: '1px solid #edf2f7' },
  eqBarChart: { display: 'flex', flexDirection: 'column', gap: '11px' },
  eqBarItem: { display: 'flex', alignItems: 'center', fontSize: '15px' },
  eqName: { width: '80px', fontWeight: 'bold' },
  barContainer: { flex: 1, backgroundColor: '#edf2f7', borderRadius: '6px', height: '25px', position: 'relative', overflow: 'hidden' },
  barFill: { height: '100%', borderRadius: '6px' },
  barLabel: { position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', fontSize: '13px', fontWeight: 'bold' },
  tableContainer: { maxHeight: '200px', overflowY: 'auto' },
  expenseTable: { width: '100%', borderCollapse: 'collapse', fontSize: '15px' },
  td: { padding: '10px', borderBottom: '1px solid #edf2f7' },
  th: { padding: '10px', borderBottom: '2px solid #e2e8f0', textAlign: 'left', backgroundColor: '#f8fafc', position: 'sticky', top: 0 },
  bottomGrid: { display: 'grid', gridTemplateColumns: '1.2fr 1fr 1fr', gap: '20px' },
  clientList: { display: 'flex', flexDirection: 'column', gap: '9px' },
  clientItem: { display: 'flex', alignItems: 'center', fontSize: '14px' },
  clientName: { width: '76px', color: '#4a5568', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' },
  clientBarContainer: { flex: 1, backgroundColor: '#edf2f7', height: '18px', position: 'relative', borderRadius: '4px' },
  clientBarFill: { height: '100%', backgroundColor: '#3182ce', borderRadius: '4px' },
  clientValue: { position: 'absolute', right: '5px', top: '50%', transform: 'translateY(-50%)', fontSize: '12px', fontWeight: 'bold' },
  noteInputGroup: { marginBottom: '11px' },
  noteInput: { width: '100%', padding: '10px', borderRadius: '7px', border: '1px solid #cbd5e0', boxSizing: 'border-box', fontSize: '15px' },
  noteList: { display: 'flex', flexDirection: 'column', gap: '7px' },
  noteItem: { display: 'flex', justifyContent: 'space-between', padding: '10px 12px', backgroundColor: 'white', borderRadius: '7px', fontSize: '14px', border: '1px solid #edf2f7' },
  delBtn: { border: 'none', backgroundColor: 'transparent', color: '#e53e3e', cursor: 'pointer', fontSize: '15px' }
};
