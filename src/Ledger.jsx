    ...
    try {
      ...
      rows.forEach(newR => {
        const isDup = existing.some(oldR => 
          ...
          oldR.amount === newR.amount && oldR.method === newR.method && oldR.description === newR.description
        );
    ...
    <div style={styles.container}>
      <div style={styles.topSection}>
        <div style={styles.card}>
          <h3 style={styles.cardTitle}>📝 일계표 엑셀 붙여넣기</h3>
        ...
        <div style={styles.summaryCard}>
          ...
          <button onClick={handleSave} disabled={loading || rows.length===0} style={styles.greenBtn}>중복 제외 후 저장</button>
        </div>
      </div>
      <div style={styles.listCard}>
        <div style={styles.headerRow}>
          <h3 style={{margin:0}}>📅 {selectedYear}년 {selectedMonth}월 내역</h3>
        ...
        <div style={styles.scrollWrapper}>
          <table style={styles.table}>
            <thead style={styles.thead}>
              <tr><th style={{width:'12%'}}>날짜</th><th style={{width:'8%'}}>구분</th><th style={{width:'15%'}}>상호</th><th style={{width:'35%'}}>적요</th><th style={{width:'12%'}}>금액</th><th style={{width:'10%'}}>방식</th><th style={{width:'8%'}}>관리</th></tr>
            </thead>
            <tbody>
