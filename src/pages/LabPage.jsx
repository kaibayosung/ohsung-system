...
import { TaperTensionMonitorScreen } from './test/taperTensionMonitorScreen';
...
const PROJECTS = [
  ...
  { key: 'taper-tension-monitor', label: '테이퍼 텐션 컨트롤러 원격 모니터링', icon: '📟', category: '생산현장 도구', desc: '통신 포트가 없는 PR-DTC-3100 LCD를 카메라+OCR로 읽어 값을 뽑아내고, 외국인 운영자 대신 관리자가 폰으로 원격 확인·조치합니다. 카메라 거치 전 단계라 샘플 데이터입니다.', badge: '샘플' },
    ...
    <div style={styles.container}>
      ...
      {view === 'home' ? (
        ...
        <div>
          ...
          {view === 'taper-tension-monitor' && <TaperTensionMonitorScreen />}
