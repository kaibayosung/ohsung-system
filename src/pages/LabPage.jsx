...
const PROJECTS = [
  ...
  { key: 'ai-tension-monitor', label: 'PR-DTC-3100 실시간 인식 (상용)', icon: '📡', category: '생산현장 도구', desc: '폰 IP카메라 스트림을 개발서버의 ocr_monitor_production.py가 1분마다 Groq(Qwen3.8-27B)로 인식해 ai_tension_readings 테이블에 저장합니다. 출력%·전압·두께·시작경·장력설정·장력율 6개 값과 누적 현황, 최근 6시간 수신 커버리지, 최근 저장 레코드를 8초마다 갱신해 보여줍니다.', external: '/ai-tension-monitor.html', badge: '실데이터 연동' },
  ...
  { key: 'coil-inventory-search', label: '원자재 코일 검색 (발주서 매칭)', icon: '🔍', category: '생산현장 도구', desc: '발주서에 적힌 거래처명·두께로 오성철강에 입고된 재고 코일을 찾아 작업에 쓸 코일을 고릅니다. 모바일 카드 화면, 조회/참고용이며 실데이터(그린ERP 재고)로 동작합니다.', external: '/coil-inventory-search.html', badge: '실데이터 연동' },
