...
const PROJECTS = [
  ...
  { key: 'customer-chatbot', label: '고객사 챗봇 데모 (대한강재)', icon: '💬', category: '고객사 시연', desc: '진행중/완료 건수, 미출고, 미수금, 코일별 상태 등 10가지 질문에 실데이터로 답하는 규칙기반 챗봇 데모입니다. 실제 /portal과 별개, 대한강재로 범위 고정.', badge: '실데이터 연동' },
