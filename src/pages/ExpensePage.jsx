...
const styles = {
  ...
  activeTab: { padding: '12px 22px', backgroundColor: 'white', color: '#3182ce', border: 'none', borderRadius: '10px 10px 0 0', fontWeight: 'bold', cursor: 'pointer', fontSize: '14px' },
  inactiveTab: { padding: '12px 22px', backgroundColor: '#cbd5e0', color: '#4a5568', border: 'none', borderRadius: '10px 10px 0 0', fontWeight: 'bold', cursor: 'pointer', fontSize: '14px' },
  content: { backgroundColor: 'white', padding: '25px', borderRadius: '0 15px 15px 15px', boxShadow: '0 4px 10px rgba(0,0,0,0.05)', minHeight: '70vh' },
};
